    ...
    return (
        ...
        <header  style={{
          ...
          <button  style={{ float:"left" ,  marginRight:"200px",width:"100px" , backgroundColor:"#edfc44"}}> Logo</button>
            ...
            <button  style={{ float:"left" ,  marginRight:"10px",width:"70px" , backgroundColor:"#edfc44" }} >Discover</button>
            ...
            <button  style={{ float:"right" ,  marginRight:"50px",width:"70px" , backgroundColor:"#edfc44" }}   >Login</button>
             <button   style={{ float:"right" , marginRight:"50px",width:"80px" , backgroundColor:"#edfc44" , 
