      ...
      <div className="flex items-center justify-center h-screen antialiased bg-gray-200">
        <div className="flex flex-col w-11/12 max-w-2xl mx-auto border border-gray-300 rounded-lg shadow-xl sm:w-5/6 lg:w-1/2">
          ...
          <div className="flex flex-col px-6 py-5 bg-gray-50">
            ...
            <input type="text"className="h-10 p-5 mb-5 bg-white border border-gray-200 rounded shadow-sm" id="username" name="username"/>
          </div>
          <div className="flex flex-col px-6 py-5 bg-gray-50">
          ...
          <div className="flex flex-col px-6 py-5 bg-gray-50">
            ...
            <input type="password"className="h-10 p-5 mb-5 bg-white border border-gray-200 rounded shadow-sm" id="password" name="password" />
          </div>
          <div className="flex flex-row items-center justify-between p-5 bg-white border-t border-gray-200 rounded-bl-lg rounded-br-lg">
            <button className="font-semibold text-gray-600" onClick={props.hide} >Cancel</button>
            <button className="px-4 py-2 font-semibold text-black rounded bg-lime-300" type="submit">
              Login
            </button>
          </div>
          </form>
